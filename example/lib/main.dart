...
class _MyAppState extends State<MyApp> {
  final FlutterSocialLogin socialLogin = FlutterSocialLogin();

  static const FACEBOOK_APP_ID = "";
  ...
  Future<void> logInFacebook() async {
    try {
      _facebookUser = await socialLogin.logInFacebookWithPermissions(FacebookPermissions.DEFAULT);
      setState(() {});
    } catch (e) {
      print(e);
    }
...
class SocialUserDetail extends StatelessWidget {
  ...
  static const String DEFAULT_IMAGE_URL = "https://cdn.icon-icons.com/icons2/1378/PNG/512/avatardefault_92824.png";
